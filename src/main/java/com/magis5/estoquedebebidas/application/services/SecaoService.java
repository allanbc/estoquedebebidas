...
public class SecaoService {
    ...
    private final SecaoValidadorChain validatorChain;

    public SecaoService(EntityManager manager, BebidaService bebidaService, MovimentacaoBebidas movimentacaoBebidas, HistoricoService historicoService, SecaoValidadorChain validatorChain) {
